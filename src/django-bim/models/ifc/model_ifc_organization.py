...
class IfcOrganizationModel(models.Model):
    ...
    identifier = IfcIdentifierField(
        ...
        help_text = _(
            "A unique identifier for the organization, such as a registration number."  # noqa E501
        ),
    )
    ...
    roles = models.ManyToManyField(
        ...
        help_text = _(
            "Roles that the organization performs in the construction process."  # noqa E501
        ),
    )
    ...
    class Meta:
        ...
        indexes = [
            models.Index(
                fields = ["identifier"],
                name = "idx_ifc_organization_identifier"
            )
        ]
