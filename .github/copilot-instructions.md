...
# Copilot instructions — django-bim
...
- Packaging via `pyproject.toml`; keep the public API in `__init__` stable.
- Guard optional/heavy integrations behind lazy imports.
- Tests: `pytest`. Type-check if the repo configures mypy/pyright.
